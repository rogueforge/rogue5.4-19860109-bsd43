 ...
 *
 * @(#)extern.c X.XX (Berkeley) XX/XX/XX
 */
...
char Move_dir = '\0';			/* Direction of last movement command */
...
int Vf_hit = 0;				/* Number of times flytrap has hit */
